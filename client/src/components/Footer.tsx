    ...
    return (
        ...
        <div className="pt-[1.5rem] pb-[0.5rem] max-w-[95%] ">
            ...
            <div className="flex flex-wrap mx-[12px] pt-[24px]">
                ...
                <div className={`min-w-[75%]  ${!isDesktop ? "" : "pl-[1.5rem]"} `} >
                    ...
                    <div className={`pb-[1rem] font-outfit font-semibold ${!isDesktop ? "text-[1.6rem]" : "text-[2.5rem]"}  `}>
                        Book a call and get&nbsp;  
                        ...
                        to 
                         {isDesktop ? (<br />) : ""  } Intract
                    </div>

                    <button className="font-outfit rounded-2xl border-[1px] px-[1.75rem] py-[0.825rem]
